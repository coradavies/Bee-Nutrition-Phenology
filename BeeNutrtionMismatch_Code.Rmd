...
beesize_time$Date <- c("May 21", "May 21", "May 21", 
...
beenest_time$Date <- c("May 21", "May 21", "May 21", 
                       "June 3", "June 3", "June 3", "June 3",
                       "June 18", "June 18", "June 18", "June 18", 
                       "July 1", "July 1", "July 1", 
                       "July 14","July 14","July 14", "July 14", 
                       "July 28","July 28","July 28", "July 28", 
                       "Aug. 11", "Aug. 11", "Aug. 11", "Aug. 11", 
                       "Aug. 21","Aug. 21",
                       "Sept. 12","Sept. 12","Sept. 12","Sept. 12")

#visualize
fig3c<- ggplot(beenest_time, aes(x = as.factor(Date), y = IntTotal, fill = Nest1)) + 
  geom_histogram(stat = "identity", position = "fill") +
  xlab("Sample date") +
  ylab("Percent abundance (%)") +
  scale_fill_manual(values=cbPalette)+
...
#visualize
fig3d<- ggplot(beenest_meadowsize, aes(x = as.factor(Size), y = IntTotal, fill = Nest1)) + 
  geom_histogram(stat = "identity", position = "fill") +
  xlab("Canopy gap size (ha)") +
  ylab("Percent abundance (%)") +
  scale_fill_manual(values=cbPalette)+
...
beesoc_time$Date <- c("May 21", "May 21", "May 21", "May 21",
                       "June 3", "June 3", "June 3", "June 3",
                       "June 18", "June 18", "June 18", "June 18", 
                       "July 1", "July 1", "July 1", 
                       "July 14","July 14","July 14", "July 14", 
...
#visualize
fig3e<- ggplot(beesoc_time, aes(x = as.factor(Date), y = IntTotal, fill = Sociality)) + 
  geom_histogram(stat = "identity", position = "fill") +
  xlab("Sample date") +
  ylab("Percent abundance (%)") +
  scale_fill_manual(values=cbPalette)+
...
#visualize
fig3f<- ggplot(beesoc_meadowsize, aes(x = as.factor(Size), y = IntTotal, fill = Sociality)) + 
  geom_histogram(stat = "identity", position = "fill") +
  xlab("Canopy gap size (ha)") +
  ylab("Percent abundance (%)") +
  scale_fill_manual(values=cbPalette)+
...
bxp33 <- ggboxplot(
  ...
  labs(subtitle = get_test_label(stat.test33, detailed = TRUE))
bxp50 <- ggboxplot(
...
Fig4A<- ggplot(acc, aes(x = Day, y = acc, color = Trend, linetype = Trend)) +
  ...
  scale_colour_manual(labels = c('Large', 'Mid-sized', 'Small','Site Protein'), values=c("#999999", "#E69F00", "#56B4E9", "#F0E442")) +
  theme_classic()
...
Fig4B<- ggplot(acc, aes(x = Day, y = acc, color = Trend, linetype = Trend)) +
  ...
  scale_colour_manual(labels = c('Klepto', 'Multiple', 'Social', 'Solitary', 'Site Protein'), values=cbPalette) +
  theme_classic()

ggsave("Fig4_800.tiff", width = 9, height = 5, device='tiff', dpi=800)
...
Fig4C<- ggplot(acc, aes(x = Day, y = acc, color = Trend, linetype = Trend)) +
  ...
  scale_colour_manual(labels = c('Klepto', 'Above', 'Below', 'Both', 'Site Protein'), values=cbPalette) +
  theme_classic()
...
ggsave("Fig5_800.tiff", width = 5.2, height = 10, device='tiff', dpi=800)
