...
Beediversity$Shannon=vegan::diversity(Beediversity[c(3:50)], index="shannon")
...
ggsave("Fig3_800.tiff", width = 6, height = 5.5, device='tiff', dpi=800)
...
#plot
Fig4<- ggplot(acc, aes(x = Day, y = acc, color = Trend, linetype = Trend)) +
